/******************************************************************************
 * Internet of Coins                                                          *
 * network.js - networking (EXPERIMENTAL)                                     *
...
function getPeers(){var a=JSON.parse(fs.readFileSync("../network/peers.json"));return console.log(a),JSON.stringify(a)}exports.getPeers=getPeers,fs=require("fs");
